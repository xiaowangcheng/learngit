...
package com.rainbow.laundry.view.wheelView;
...
import com.rainbow.laundry.view.wheelView.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	// Wheel drawables
	private int wheelBackground = R.drawable.mr_wheel_bg;
	private int wheelForeground = R.drawable.mr_wheel_val;
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.mr_province_line_border));
		// 设置线宽
