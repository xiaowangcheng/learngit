...
public class WashShoesFragment extends BaseFragment {
    ...
    private List<Pro_good> listnew  =new ArrayList<Pro_good>();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if(view==null){
            view=inflater.inflate(R.layout.fragment_wash_shoes, null);
            initView();
        }else {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, @IdRes int i) {
                ...
                if(R.id.rb1==radioGroup.getCheckedRadioButtonId()){
                    if(!isrequest[0]){
                        ...
                        list.clear();
                        list.addAll(mapArrayList.get("21"));
                        setProRecycler();
                    }
                    isrequest[0]=true;
                    ...
                    if(!isrequest[1]){
                        ...
                        list.clear();
                        list.addAll(mapArrayList.get("22"));
                        setProRecycler();
                    }
                    isrequest[1]=true;
    ...
    private  void setProRecycler(){
         commonRecyclerViewHolder1 = new CommonRecyclerViewAdapter<Pro_good>(getActivity(),list){
            ...
            public void convert(CommonRecyclerViewHolder h, Pro_good entity, final int position) {
                ...
                h.setText(R.id.tv_price,String.valueOf(entity.getPrice()));
