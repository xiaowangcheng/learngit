package com.manage.rain.ui.laundryback;
...
public class LaundryBackActivity extends BasePageListActivity<Order.DataEntity.IndentListEntity> {
    ...
    private void setView(){
        ...
        mLRecyclerViewAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(LaundryBackActivity.this,OrderDetailActivity.class);
