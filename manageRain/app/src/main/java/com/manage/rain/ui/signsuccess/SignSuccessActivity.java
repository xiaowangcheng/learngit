package com.manage.rain.ui.signsuccess;
...
public class SignSuccessActivity extends BasePageListActivity {
    ...
    private void setView(){
        mAdapter = new CommonRecyclerViewAdapter<Comments.DataEntity.CommitListEntity>
                (SignSuccessActivity.this,listDataT) {
            @Override
...
//                h.setText(R.id.tv_address, entity.getCommitContent());
            ...
            public int getLayoutViewId(int viewType) {
                return R.layout.signsuccess_item;
            }
        };
